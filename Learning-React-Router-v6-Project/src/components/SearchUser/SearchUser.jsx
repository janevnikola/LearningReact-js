...
const SearchUser = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (username) {
      handleGetUser().catch(() => {
        //od handleGetUser funkcijata ne se frla exception, no se vrakja response, dokolku e false
        //se setiraat attemts na attempts -1 i se setira errorMessage koj sto se prikazuva
        setLoading("Submit");
